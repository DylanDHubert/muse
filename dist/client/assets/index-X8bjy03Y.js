...
const h = class t {
  ...
  extendCurrentPlatform(t) {
    if (!this.currentPlatform) return;
    const e = t - this.platformStartX,
      s = this.platformStartX + e / 2;
    (this.currentPlatform.width = Math.max(1, e)), (this.currentPlatform.x = s);
...
const d = class t extends i.Scene {
  ...
  updateCharacterHeight() {
    const t = this.character.body,
      e = this.findHighestPlatformAt(this.character.x);
    if (null !== e) {
      const s = e - 10,
        i = this.character.y,
        a = s - i;
      if (Math.abs(a) > 0.5) {
        const e = 0.08,
          a = Phaser.Math.Linear(i, s, e);
        (this.character.y = a), t.setVelocityY(0);
      } else (this.character.y = s), t.setVelocityY(0);
    } else {
      const { height: e } = this.cameras.main,
        s = e - 60;
      this.character.y < s
        ? t.setVelocityY(300)
        : ((this.character.y = s), t.setVelocityY(0));
    }
  }
...
//# sourceMappingURL=index-X8bjy03Y.js.map
