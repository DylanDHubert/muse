...
class o extends i.Scene {
  ...
  create() {
    ...
    (this.character = this.add.rectangle(100, e - 60, 30, 40, 3447003)),
  ...
  makeCharacterJump(t) {
    const e = this.character.body,
      ...
      i = this.getKeyHeight(t),
      r = 250 + 0.8 * Math.abs(s - i);
    e.setVelocityY(-r),
      console.log(
        `Character jumping from ${this.currentKey} to ${t} (velocity: ${r})`,
      );
  }
  getKeyHeight(t) {
    const { height: e } = this.cameras.main;
...
//# sourceMappingURL=index-D-XldnF9.js.map
