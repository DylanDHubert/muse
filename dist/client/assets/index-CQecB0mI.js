...
class o extends i.Scene {
  ...
  create() {
    ...
    const i = this.add.rectangle(50, e - 50, 200, 20, 3066993);
  ...
  createSimplePlatform() {
    const { height: t } = this.cameras.main,
      e = this.character.x + 150,
      s = t - 100,
      i = this.add.rectangle(e, s, 100, 20, 3066993);
    this.physics.add.existing(i, !0), this.platforms.add(i);
  }
  createPlatform() {
    this.createSimplePlatform();
  }
...
//# sourceMappingURL=index-CQecB0mI.js.map
