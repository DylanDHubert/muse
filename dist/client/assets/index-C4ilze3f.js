...
class o extends a.Scene {
  ...
  createPlatform() {
    ...
    const r = this.add.particles(e, s, "spark", {
...
class h extends a.Scene {
  ...
  preload() {
    this.load.setPath("assets"),
      ...
      this.load.image(
        "spark",
        "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAQAAAAECAYAAACp8Z5+AAAAG0lEQVQIHWPY9+8fAzYwirkTmwGbOLEZsIkTmwEAO4QH/VN/CQAAAABJRU5ErkJggg==",
      );
  }
  create() {
    this.scene.start("MainMenu");
...
//# sourceMappingURL=index-C4ilze3f.js.map
