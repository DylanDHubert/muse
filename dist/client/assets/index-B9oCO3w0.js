...
const o = class t extends i.Scene {
  ...
  makeCharacterJump(e) {
    ...
    if ((console.log(`Moving from level ${i} to ${r} (${e})`), a <= 0))
      ...
      const e =
        t.GAME_CONSTANTS.SIMPLE_JUMP_BASE -
        a * t.GAME_CONSTANTS.SIMPLE_JUMP_MULTIPLIER;
      s.setVelocityY(e),
        console.log(`Jumping up ${a} levels with velocity ${e}`);
    }
  }
...
//# sourceMappingURL=index-B9oCO3w0.js.map
