...
const o = class t extends i.Scene {
  ...
  update() {
    ...
    if (
      (Object.keys(this.gameKeys).forEach((t) => {
        ...
        e && Phaser.Input.Keyboard.JustDown(e) && s.push(t);
      }),
      s.length > 0)
    ) {
      const t = this.getHighestReachableKey(s);
      console.log(`Keys pressed: ${s.join(",")}, going to: ${t}`),
        this.switchToKey(t);
    }
  ...
  makeCharacterJump(e) {
    ...
    if ((console.log(`Moving from level ${i} to ${r} (${e})`), a <= 0))
      ...
      const e =
        t.GAME_CONSTANTS.JUMP_BASE_VELOCITY -
        a * t.GAME_CONSTANTS.JUMP_LEVEL_MULTIPLIER;
      s.setVelocityY(e),
...
//# sourceMappingURL=index-_pqTzz6z.js.map
