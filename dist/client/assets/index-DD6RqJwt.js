...
class o extends i.Scene {
  ...
  create() {
    ...
    const s = this.add.rectangle(100, e - 50, 200, 20, 9807270);
    ...
    i.setCollideWorldBounds(!0),
      i.setBounce(0.1),
      i.setMaxVelocity(200, 1e3),
  ...
  makeCharacterJump(t) {
    this.character.body.setVelocityY(-450),
      console.log(
        `Character jumping from ${this.currentKey || "neutral"} to ${t}`,
      );
  }
  getKeyHeight(t) {
    const { height: e } = this.cameras.main;
...
//# sourceMappingURL=index-DD6RqJwt.js.map
