...
const d = class t extends i.Scene {
  ...
  updateCharacterHeight() {
    const e = this.platformManager.getCurrentKey();
    if (!e) return;
    const s = this.character.body,
      { height: i } = this.cameras.main,
      a = i + t.GAME_CONSTANTS.LEVEL_HEIGHTS[e] - 10 - this.character.y;
    if (Math.abs(a) > 5) {
      const t = 200,
        e = a > 0 ? 1 : -1;
      s.setVelocityY(e * t);
    } else s.setVelocityY(0);
  }
  gameOver() {
...
document.addEventListener("DOMContentLoaded", () => {
  new i.Game({ ...y, parent: "game-container" });
});
//# sourceMappingURL=index-D7Xx1kAu.js.map
