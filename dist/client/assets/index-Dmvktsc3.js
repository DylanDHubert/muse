...
class o extends i.Scene {
  ...
  createSimplePlatform() {
    const { height: t } = this.cameras.main,
      e = this.character.x + 80,
      s = this.character.y + 20,
      i = this.add.rectangle(e, s, 120, 20, 3066993);
    this.physics.add.existing(i, !0),
      this.platforms.add(i),
      console.log(
        `Platform created at x:${e}, y:${s}, character at x:${this.character.x}, y:${this.character.y}`,
      );
  }
  createPlatform() {
    this.createSimplePlatform();
...
//# sourceMappingURL=index-Dmvktsc3.js.map
